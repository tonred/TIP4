...
contract SampleCollection is CollectionBase4_3, JSONMetadataBase, ISampleCollection, CheckPubKey, RandomNonce {
    ...
    constructor(TvmCell nftCode, TvmCell indexBasisCode, TvmCell indexCode, string json, address admin) public checkPubKey {
        tvm.accept();
    ...
    function mint(string name, address owner, address manager, string json) public view onlyAdmin {
        ...
        _mint(id, owner, manager, json, msg.sender);
    ...
    function _mint(uint256 id, address owner, address manager, string json, address creator) private view {
        ...
        new SampleNFT{
            ...
            flag: 1,
            bounce: true
        }(owner, manager, _indexCode, json, creator);
    }
